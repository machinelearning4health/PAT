...
def pat(fuzz_val, top_k_words, qrs, sample_index, text_ls, true_label,
...
def main():
    ...
    log_file = "results_hard_label/"+args.target_model+"/"+args.target_dataset+"/pat_log.txt"
 
    result_file = "results_hard_label/"+args.target_model+"/"+args.target_dataset+"/pat_results_final.csv"
    ...
    with open(os.path.join(args.output_dir, args.target_model+'pat_adversaries.txt'), 'w') as ofile:
